...
class TestCyclePrepareInputs:
    ...
    def fixture_real_causal_input_ids(self, causal_tokenizer):
        ...
        self.real_fst = 10
        self.real_snd = 6
        input_ids = causal_tokenizer(["A"*self.real_fst, "A"*self.real_snd], return_tensors="pt", padding=True)["input_ids"]
        return input_ids
    ...
    def fixture_synth_causal_input_ids(self, causal_tokenizer):
        ...
        self.synth_fst = 8
        self.synth_snd = 10
        input_ids = causal_tokenizer(["B"*self.synth_fst, "B"*self.synth_snd], return_tensors="pt", padding=True)["input_ids"]
        return input_ids
